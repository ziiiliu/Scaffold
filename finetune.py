...
class FineTune(object):
    def __init__(self, dataset, config):
        ...
        dir_name = current_time + '_' + config['task_name'] + '_' + config['dataset']['target'] + '_' + config['aug']
    ...
    def train(self):
        ...
        if self.config['model_type'] == 'gin':
            from models.gin_finetune import GINet
        ...
        for epoch_counter in range(self.config['epochs']):
            ...
            if epoch_counter % self.config['eval_every_n_epochs'] == 0:
                if self.config['dataset']['task'] == 'classification': 
                    ...
                    self.writer.add_scalar('validation_roc_auc', valid_cls, global_step=valid_n_iter)
                    ...
                    self.writer.add_scalar('validation_rmse', valid_rgr, global_step=valid_n_iter)
